...
public class OfflineInstrumentor {
  public static boolean instrumentJars(List<String> jarList, boolean addNativeLibs, String customHooksJarPath)
      throws IOException {
    AgentInstaller.install(true, customHooksJarPath);
